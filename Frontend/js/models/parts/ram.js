...
export default class RAM {
    constructor(ID, SerialNumber, Manufacturer, Model, Price, MemoryGB, FrequencyMHz) {
        this.ID = ID;
    ...
    returnRendered() {
        ...
        let prevodi = ['Serijski broj', 'Proizvođač', 'Model', 'Cena', 'Memorija (GB)', 'Frekvencija (MHz)'];
        ['SerialNumber', 'Manufacturer', 'Model', 'Price', 'MemoryGB', 'FrequencyMHz'].forEach((svojstvo, i) => {
