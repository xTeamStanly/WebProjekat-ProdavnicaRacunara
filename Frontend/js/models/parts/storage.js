...
export default class Storage {
    constructor(ID, SerialNumber, Manufacturer, Model, Price, MemoryGB) {
        this.ID = ID;
    ...
    returnRendered() {
        ...
        hederCelija.innerText = 'Skladište';
        ...
        let prevodi = ['Serijski broj', 'Proizvođač', 'Model', 'Cena', 'Memorija (GB)'];
        ['SerialNumber', 'Manufacturer', 'Model', 'Price', 'MemoryGB'].forEach((svojstvo, i) => {
